...
6. `COMPASS-SECRETS.local.md` — read ONLY to learn what to exclude; never copy a value out of it.
...
- Never put a secret, credential, token, password, or anything from `COMPASS-SECRETS.local.md` into the
  ...
  "items": [
    {
      ...
      "provenance": { "cowork_source": "02-activity-spike-strategy.md", "note": "" },
...
## 5. Privacy gate
- **Never sync:** any secret/credential/token/password; anything in `COMPASS-SECRETS.local.md`.
